...
import com.fallmerayer.radathina.global.Util;
        ...
        btnRoute.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                try {
                    ...
                    Global.fusedLocationClient.getLastLocation().addOnSuccessListener(getActivity(),
                            new OnSuccessListener<Location>() {
                                @Override
                                public void onSuccess(Location location) {
                                    if (location != null) {
                                        loadRoute(Util.locationToLatLng(location), attractionLatLng);
                                    }
                                }
                            });
